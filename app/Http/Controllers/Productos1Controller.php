...
class Productos1Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $productos = Productos1::where('estado', '=', '1')->where('descripcion', 'like', '%' . $buscarpor . '%')->paginate($this::PAGINATION);
        return view('productos1.index', compact('productos', 'buscarpor'));
    }
    ...
    public function create()
    {
        ...
        $producto = new Productos1();

        return view('productos1.create', compact('categorias', 'unidades', 'producto'));
    }
    ...
    public function store(Request $request)
    {
        ...
        */
        ...
        return redirect()->route('productos1.index')->with('datos', 'Registro Nuevo Guardado...!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $productos->update();
        return redirect()->route('productos1.index')->with('datos', 'Registro Actualizado...!');
    }
    ...
    {
        $productos = Productos1::findOrFail($id);
        return view('productos1.confirmar', compact('productos'));
    }
    public function destroy($id)
    {
        ...
        $productos->estado = '0';
        $productos->save();
        return redirect()->route('productos1.index')->with('datos', 'Registro Eliminado...!');
    }
}
