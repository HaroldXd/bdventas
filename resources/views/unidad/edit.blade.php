...
->idunidad)}}">
 ...
 <input type="text" class="formcontrol" id="id" name="id" value="{{ $unidad->idunidad }}" disabled>

 </div>
 <div class="form-group">
 <label for="">Descripción</label>
 <input type="text" class="formcontrol @error('descripcion') isinvalid @enderror" id="descripcion" name="descripcion" value="{{ $unidad->descripcion }}">
 @error('descripcion')
