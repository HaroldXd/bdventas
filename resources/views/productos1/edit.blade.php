...
@section('contenido')
    <div class="container">
        ...
        <form method="POST" action="{{ route('productos1.update', $productos->idproducto) }}" enctype="multipart/form-data">
            @method('put')
            @csrf
    ...
    <a href="{{ route('cancelar_prod1') }}" class="btn btndanger"><i class="fas fa-ban"></i> Cancelar</button></a>
    </form>
    </div>
@endsection
