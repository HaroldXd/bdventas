...
@section('contenido')
 ...
 <form method="POST" action="{{ route("sucursales.update",$sucursales->idsucursal)}}">
 @method('put')
 @csrf
 ...
 <div class="input-group flex-nowrap">
    ...
    <input type="text" class="form-control" placeholder="descripcion" aria-label="descripcion"
        ...
        name="descripcion" value=" {{ $sucursales->descripcion }}">
    @error('descripcion')
...
<div class="input-group flex-nowrap">
    ...
    <input type="text" class="form-control" placeholder="direccion" aria-label="direccion"
        ...
        name="direccion" value=" {{ $sucursales->descripcion }}">
    @error('direccion')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<div class="flex flex-col justify-around h-full">
    ...
    <div>
        ...
        <input type="text" class="form-control" placeholder="servicios" aria-label="idservicios"
            aria-describedby="addon-wrapping" id="idservicio" name="idservicio" readonly value="">
    ...
    <div class="card body" style="font-size: 20px">
        <textarea  cols="5" rows="5"id="idhorario" name="idhorario" value="{{ $sucursales->idservicios}}" ></textarea>
