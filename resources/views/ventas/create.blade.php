...
<div class="container">
    <h1>Registrar Venta</h1>        
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    @foreach($cliente as $itemcliente) <option value="{{ $itemcliente->cliente_id }}_{{ $itemcliente->ruc_dni }}_{{ $itemcliente->direccion }}" >{{ $itemcliente->nombres }}</option>
                    @endforeach
                    </select>                  
                </div>
            </div>            
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <label hidden name="lblsub" id="lblsub">Subtotal : </label>
            </div>
            <div class="col-md-2">
                <input hidden type="text" class="form-control text-right" name="subtotal" id="subtotal" readonly="readonly">
            </div>
            <div class="col-md-8">
            </div>
            <div class="col-md-2">
                <label hidden name="lbligv" id="lbligv">IGV : </label>
            </div>
            <div class="col-md-2">
                <input hidden type="text" class="form-control text-right" name="igv" id="igv" readonly="readonly">
            </div>      
...
<script src="/adminlte/dist/js/createdoc.js"></script>
