    ...
    <div class="container">
        ...
        <nav class="navbar navbar-light float-right">
            <form class="form-inline my-2 my-lg-0" method="GET">
                <input name="buscarpor" class="form-control mr-sm2" type="search" placeholder="Busqueda por descripcion"
                ...
                <tbody>
                    @foreach ($venta as $itemventa)
                        <tr>
                            ...
                            <td><a href="{{ route('ventas.pdf', $itemventa->venta_id) }}"target="_blank"
