...
function mostrarProducto() {
    ...
    $.get('/admin/EncontrarProducto/' + idproducto, function (data) {
...
function mostrarTipo() {
    tipo_id = $("#seltipo").val();
    $.get('/admin/EncontrarTipo/' + tipo_id, function (data) {
...
function verificatipo() {
    ...
    if (tipo_id == '1') {
        ...
        document.getElementById("igv").hidden = false;

        document.getElementById("lblsub").hidden = false;
        ...
        document.getElementById("igv").hidden = true;

        document.getElementById("lblsub").hidden = true;
